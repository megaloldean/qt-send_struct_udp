...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_UdpServer_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_UdpServer_t qt_meta_stringdata_UdpServer = {
    {
QT_MOC_LITERAL(0, 9), // "UdpServer"
QT_MOC_LITERAL(10, 16), // "slotSendDatagram"
QT_MOC_LITERAL(27, 0) // ""

    },
    "UdpServer\0slotSendDatagram\0"
};
...
void UdpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slotSendDatagram(); break;
        default: ;
        }
    }
    (void)_a;
...
const QMetaObject UdpServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_UdpServer.offsetsAndSize,
    qt_meta_data_UdpServer,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_UdpServer_t
